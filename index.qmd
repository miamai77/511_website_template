...
```{r, fig.width=6, fig.height=3, fig.cap="Plot of Evangelical Protestant Population"}
...
```{r, fig.width=6, fig.height=3, fig.cap="Plot of Mormon Population"}
...
```{r, fig.width=6, fig.height=3, fig.cap="Plot of Black Protestant Population"}
